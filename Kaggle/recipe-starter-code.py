...
with open('C:/Users/Craig/Desktop/Kaggle/Recipes/train.json') as train_f, open('C:/Users/Craig/Desktop/Kaggle/Recipes/test.json') as test_f:
...
scores = cross_val_score(rf_classifier, train_X, train_Y)
scores.mean()
...
d.to_csv('C:/Users/Craig/Desktop/Kaggle/Recipes/train/submission.csv', index=False)
